...
- Full API signatures and option details: `docs/api-reference.md`
- Custom HTML and sandbox integration: `docs/custom-html-sandbox.md`
- Real-world implementation patterns: `docs/recipes.md`
- Package-level LFForm reference: `packages/types/DOCS.md`

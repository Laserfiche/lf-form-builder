...
Defined in: packages/core/src/components/starRating.ts:5
...
`StarRatingWindow`.[`frameElement`](#frameelement)
...
Defined in: packages/core/src/components/starRating.ts:6

#### Parameters

##### event

[`OnClickEvent`](../type-aliases/OnClickEvent.md)
...
> **LFForm**: [`LFForm`](../../lf-form-types/type-aliases/LFForm.md)
...
`StarRatingWindow`.[`visualViewport`](#visualviewport)
...
`StarRatingWindow`.[`window`](#window)
...
`StarRatingWindow`.[`location`](#location)

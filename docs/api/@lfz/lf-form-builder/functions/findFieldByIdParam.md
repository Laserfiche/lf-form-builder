[Documentation](../../../index.md) / [@lf/lf-form-builder](../index.md) / [](../README.md) / findFieldByIdParam

# Function: findFieldByIdParam()

> **findFieldByIdParam**\<`FieldType`\>(`fieldId`): `FieldType`[]

Defined in: [packages/core/src/lib/findFieldByLFFormId.ts:26](https://github.com/Laserfiche/lf-form-builder/blob/930ac99256d1304cbde6b15cdc0da8e44a4a7262/packages/core/src/lib/findFieldByLFFormId.ts#L26)

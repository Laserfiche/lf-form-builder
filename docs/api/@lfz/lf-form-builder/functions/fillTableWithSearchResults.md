...
> **fillTableWithSearchResults**(`tableFieldId`, `results`, `valueMap`): `Promise`\<`PromiseSettledResult`\<[`LFFormPromiseResponse`](../../lf-form-types/type-aliases/LFFormPromiseResponse.md)\>[] \| `undefined`\>
